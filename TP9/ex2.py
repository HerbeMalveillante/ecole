class Voiture():
    ...
    def affiche(self):
        print("La voiture est une", self.marque, self.modele, "et elle a parcouru", self.mileage, "km.")
...
class Conducteur():
    ...
    def conduit(self, voiture, nb_km):
        voiture.roule(nb_km)
        voiture.affiche()
        print(f"{self.nom} a conduit une {voiture.marque} {voiture.modele} pendant {nb_km}km.")
