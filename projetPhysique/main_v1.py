...
def update_graph(_): # _ is a dummy variable because the function is called with an argument by default
    global frame2
...
def draw_graph(initialSpeed, initialHeight, angle, gravity): # draw the graph
    ...
    x, y = draw_trajectory_graph(initialSpeed, initialHeight, angle, gravity) # get the coordinates of the trajectory
