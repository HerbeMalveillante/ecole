class Chat:
    ...
    def affiche(self):
        print(
            f"""Carte d'identité de {self.nom} :
    Race : {self.race}
    Poids : {self.poids}
    ...
    def estPlusGros(self, autreChat):
        if self.poids == autreChat.poids:
            ...
            print(
                f"{self.nom if self.poids > autreChat.poids else autreChat.nom} est plus gros que {self.nom if self.poids < autreChat.poids else autreChat.nom} "
            )
    ...
    def estPlusVieux(self, autreChat):
        if self.naissance == autreChat.naissance:
            ...
            self.naissance > autreChat.naissance or self.naissance < autreChat.naissance
        ):
            print(
                f"{self.nom if self.naissance < autreChat.naissance else autreChat.nom} est plus vieux que {self.nom if self.naissance > autreChat.naissance else autreChat.nom} "
            )
