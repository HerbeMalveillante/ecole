...
def demoExo5():
    ...
    for i in range(5):
        print(
            ecartType(
                [random.randint(1, 1000) for i in range(random.randint(300, 1000))]
            )
        )
    print(
        "On constate que même avec des listes aléatoires de grande taille, l'écart type est toujours assez similaire."
    )
