...
class ArbreTraite(Arbre):
    ...
    def traitementAnnee(self, annee):
        ...
        for i in self.dates:
            if i[2] == annee:
                count += 1
        print(f"Essence : {self.ref.split(' ')[0]} ; position : ({self.ref.split(' ')[1]};{self.ref.split(' ')[2]}) ; Traitement effectué {count} fois en {annee}")
...
at1 = ArbreTraite("Chêne 47.052547 4.383553", "Pulvérisation de bacille de Thuringe", [(5,9,2017),(12,4,2018),(15,6,2018)], 108, 3)
at1.affiche()
