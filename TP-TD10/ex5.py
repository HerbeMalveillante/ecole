class Ruche():
    ...
    def picActivite(self):
        ...
        print(f"Activité maximale : {Max} kg le(s) jour(s) {';'.join([str(i+1) for i in indexMax])}")
...
class RucheParrainee(Ruche):
    ...
    def afficheToutes(cls, nom):
        ...
        print(f"{len(ruchesParrainees)} ruches parrainées par {nom} : {' ; '.join(ruchesParrainees)}")
        print(f"Valeur totale : {sum([cls.parrainages[i][1] for i in ruchesParrainees])} €")
                



r1 = RucheParrainee("Bois de Houx a2", [(32.6,31.9),(32.7,31.6),(32.8,31.8),(32.9,31.6),(33.1,32.9),(33.1,32.7),(33.2,31.9),(33.4,33.1)], [50,80,60,50,80,80,0,80,20,10], "Alfred", 3500)
r2 = RucheParrainee("Bois de Houx a3", [(32.6,31.9),(32.7,31.6),(32.8,31.8),(32.9,31.6),(33.1,32.9),(33.1,32.7),(33.2,31.9),(33.4,33.1)], [50,80,60,50,80,80,0,80,20,10], "Alfred", 4100)
r3 = RucheParrainee("Bois de Houx a4", [(32.6,31.9),(32.7,31.6),(32.8,31.8),(32.9,31.6),(33.1,32.9),(33.1,32.7),(33.2,31.9),(33.4,33.1)], [50,80,60,50,80,80,0,80,20,10], "Gerard", 2500)
